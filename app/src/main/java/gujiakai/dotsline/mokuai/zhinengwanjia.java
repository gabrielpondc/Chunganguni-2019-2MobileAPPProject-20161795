...
public class zhinengwanjia extends wanjia {
    private int nanyidu;
    ...
    private zhinengwanjia(int nanyidu, youxi Youxi) {
        this(null);
        this.setNanyidu(nanyidu);
        this.jiarudaoyouxi(Youxi);
    }

    public zhinengwanjia(String mingzi) {
        super(mingzi);
    ...
    private Xian xian(Mianban mianban) {
        for (int a = 0; a < 6; a++) {
            for (int b = 0; b < 5; b++) {
                shuipinxian[a][b] = mianban.chuzhixian[a][b];
                chuizhixian[b][a] = mianban.shuipingxian[b][a];
            }
        }
        for (int a = 0; a < 5; a++) {
            for (int b = 0; b < 5; b++) {
    ...
    class Mianban {
        ...
        int huoquhuaizhi(Xian xian) {
            ...
            zhinengwanjia ai = new zhinengwanjia(0, huoquyouxi());
            csh();
        ...
        int haoxianzhi(Xian xian) {
            ...
            if (xian.fangxiang() == fangxiang.SHUIPINGXIAN)
                ...
                this.shuipingxian[xian.lie()][xian.yuanzhu()] = true;
            zhinengwanjia computer = new zhinengwanjia(0, huoquyouxi());
            csh();
            kaishi = this.huoquzhanlingshu();
            jixuzou = true;
            while (jixuzou) {
        ...
        int huoqushifounengshengli(Xian xian) {
            csh();
            ...
            zhinengwanjia cjisuan = new zhinengwanjia(2, huoquyouxi());
            int xianzaikaishi;
            if (wo == 1)
                xianzaikaishi = 0;
            else
